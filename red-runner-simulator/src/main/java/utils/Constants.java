...
public class Constants {
	...
	public static final String MAIN_FILE_PATH = "/Users/michaellasso/Documents/hackatons/red-runners/resources/";
	public static final String TRAFFIC_FILE_PATH = MAIN_FILE_PATH + "traffic_light.txt";
	public static final String CHECKER_FILE_PATH = MAIN_FILE_PATH + "checker.sh";
	public static final String TIMESTAMP_FILE_PATH = MAIN_FILE_PATH + "timestamp.txt";
	public static final String COORDS_FILE_PATH = MAIN_FILE_PATH + "coordinates.txt";
